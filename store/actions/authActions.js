...
const signInWithGoogleAsync = async (firebase, firestore) => {
  try {
    ...
    const result = await Google.logInAsync({
      androidClientId:
        "455439935142-4p702jhmnpa8a9ulnatd9l6gij5ii414.apps.googleusercontent.com",
      behavior: "web",
      iosClientId:
        "455439935142-9t7kmcsma3bnc43rltekuk8bq93dkacn.apps.googleusercontent.com",
...
export const signIn = () => {
  return (dispatch, getState, getFirebase) => {
    ...
    signInWithGoogleAsync(firebase, firestore)
      .then(() => {
